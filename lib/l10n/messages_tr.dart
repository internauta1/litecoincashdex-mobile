...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m7(appName) =>
      "Hayır ! Litecoin Cash Wallet, gözetimsiz bir cüzdandır. Özel kelimeleriniz, gizli kelimeleriniz ve PIN kodunuz dahil hiçbir hassas bilgiyi kaydetmiyoruz. Bu bilgiler sadece kullanıcının cihazında tutulmaktadır ve başka bir yere gitmez. Bu sayede koin ve tokenlerinizin tüm kontrolü sizdedir.";
  ...
  static m87(appName) => "Litecoin Cash Wallet\'ı hangi cihazlarda kullanabilirim ?";
  ...
  static m90(appName) => "Litecoin Cash Wallet\'ın arkasında kimler var ?";
  ...
  static m116(appName) => "Litecoin Cash Wallet güncellemeleri";
  ...
  static m119(appName) =>
      "Litecoin Cash Wallet mobil yerleşik üçüncü nesil DEX işlevselliği ve daha fazla özellikleri ile yeni nesil bir çoklu koin cüzdanıdır.";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "answer_4": MessageLookupByLibrary.simpleMessage(
            "Evet, takas boyunca uygulamanız açık ve internetinizin de (anlık kesintilerde bir sıkıntı yoktur) bağlı olması gerekmektedir. Aksi halde; eğer yapıcı emri (maker) veren siz iseniz takasın iptal olma durumu, alıcı emri (taker) veren iseniz de koinlerinizi kaybetme riski ortaya çıkar. Litecoin Cash Wallet protokolünde takası yapan her iki tarafın da işlem boyunca çevrimiçi olması ve takasın başarılı olması için gereklidir."),
        "answer_5": m11,
        "answer_6": m12,
        "answer_7": m13,
        "answer_8": m14,
        ...
        "rebrandingAnnouncement": MessageLookupByLibrary.simpleMessage(
            "Bu yeni bir dönem! \'Litecoin Cash DEX\' olan ismimizi resmi olarak \'Litecoin Cash Wallet\' olarak değiştirdik."),
