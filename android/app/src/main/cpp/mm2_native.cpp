...
Java_com_litecoincash_mobile_MainActivity_nativeMm2Main(
    JNIEnv *env,
    jobject, /* this */
    jstring conf,
...
extern "C" JNIEXPORT jbyte JNICALL
Java_com_litecoincash_mobile_MainActivity_nativeMm2MainStatus(
    JNIEnv *,
    jobject /* this */) {
...
extern "C" JNIEXPORT jbyte JNICALL
Java_com_litecoincash_mobile_MainActivity_nativeMm2Stop(
    JNIEnv *,
    jobject /* this */) {
